<template>
    <div>
        <v-header scrollTo="#ekipa" vtitle="Ekipa" coverImg="../img/zespol2.jpg" style="background-position-y: -90px;"></v-header>
                ...
                <div class="row">
                    <article class="col-md-12 text-center">
                        ...
                        <div class="container">
                            ...
                            <h1 class="text-uppercase pb-2">Sekcja DJ-ska</h1>
                            <div class="mr-1 text-justify">
                                <p>
...
<!--                                <div class="col-md-2 col-xs-9 text-center">
                            ...
                            <h1 class="text-uppercase pb-2">Sekcja Techniczna</h1>
                            <div class="mr-1 text-justify">
                                <p>
