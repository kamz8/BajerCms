                ...
                <b-form @submit.prevent="validateBeforeSubmit()">
                  ...
                  >
                    <b-form-textarea
                      ...
                      :aria-invalid="errors.first('message')"
                    />
                  </b-form-group>
                  <b-button
                    type="submit"
                    variant="primary"
                    :disabled="errors.any() || isSending"
                  >
                    Wyślij <span
                      v-show="isSending"
                    ><i class="fa fa-spinner fa-spin" /></span>
                  </b-button>
                </b-form>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          <article class="col-md-12 text-center">
            ...
            <div class="row text-justify justify-content-left">
              <div class="col-md-6 col-xs-12 col-lg-3">
                <avatar
                  name="#DawidOOs"
                  member-type="Przewodniczący sekcji DJ-skiej"
              ...
              <div class="col-md-6 col-xs-12 col-lg-3">
                ...
                >
                  <social-link
                    type="facebook"
                    href="https://www.facebook.com/DJ.CR1SS"
                  />
                </avatar>
              </div>
              <div class="col-md-6 col-xs-12 col-lg-3">
            ...
            <div class="row text-justify justify-content-left">
              ...
              <div class="col-md-6 col-xs-12 col-lg-3">
                ...
                >
                  <social-link
                    type="facebook"
                    href="https://www.facebook.com/W.Obuchowski1FOTO"
                  />
                </avatar>
              </div>
              <div class="col-md-6 col-xs-12 col-lg-3">
