            ...
            <div class="container h-100">
                <div class="row align-items-center h-100">
                    <div class="col-12 col-md-3">
                        <img class="img-fluid mx-auto w-50 d-block" src="img/bajer.png">
                    ...
                    <div class="col-12 col-md-3">
                        <router-link :to="{name: 'contact'}" class="btn btn-light text-uppercase text-dark btn-block mt-5 mt-md-0">kontakt</router-link>
                    </div>
                </div>
            </div>
