<template>
    <div>
        ...
        <section id="oferta" class="content-box bg-image" style="background-image: url('img/oferta-bg.jpg')">
            <div class="container">
                <div class="row">
                    <article class="col-md-12 text-center">
...
<script>
    import FacebookEvents from "./FacbookEvents";
    export default {
        name: "home",
        components: {FacebookEvents},
    }
</script>
