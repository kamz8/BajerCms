<template>
  <div class="fb-events">
    <div class="row">
      <div
        v-for="(event, index) in getEventsStore"
        :key="index"
        ...
        <article class="row">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 text-left">
            <div class="row mt-3 mb-3">
              <div class="col-12 d-sm-none pb-3 pb-md-0">
                <h2 class="title">
                  <a
              ...
              <div class="col-8 col-md-10 col-lg-10">
                ...
                <div class="row">
                  <div class="col-4 col-md-3 pl-0 pl-md-2">
                    <time class="hour-start"><i class="fa fa-clock-o" />&nbsp;{{ hoursFromDate(event.start_time) }}
                    </time>
                  </div>
                  <div class="col-8 col-md-9 pl-0 pl-md-2">
                    <span class="place"><i class="fa fa-map-marker" />&nbsp;{{ event.place.name }}</span>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    formatDate(value, format = 'day') {
      const result = { day: moment(String(value)).format('D'), month: moment(String(value)).format('MMM') };
      return (result[format]) ? result[format] : '';
    },
    hoursFromDate(value) {
